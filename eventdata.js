// ==========================================================================
// 🌀 eventdata.js：40種邪神與仙子事件 & 40種隨機寶箱數據庫 (對接 RO 六大屬性 & 背包安全防護)
// ==========================================================================
...
const ABYSS_EVENTS_DATABASE = [
    ...
    { 
        ...
        choices: [
            { text: "🔥 用大火燒（獲得 60G 金幣，但有 50% 機率吸入毒氣扣 20 HP）", run: (run) => { if(Math.random()<0.5) { run.hp = Math.max(1, run.hp - 20); run.gold += 60; return "🤮 大火燃燒蛛絲釋放了劇毒障氣！你大口喘氣吸入肺部。"; } else { run.gold += 60; return "🔥 烈火沖天！蛛絲和蟲卵付之一矩，你踏著灰燼拾起金幣。"; } } }
        ] 
    },
    { 
        title: "🪐 重力奇異點黑洞殘骸", 
