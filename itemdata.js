// ==========================================================================
// 📦 itemdata.js：皇家魔導熔爐 & 頂級料理食譜庫 (標準化屬性 Key)
// ==========================================================================

const CRAFTING_BLUEPRINTS = [
    // ==================== 🛠️ LEVEL 1-10 基礎魔導 ====================
    { name: "🗡️ 獸王重劍", type: "weapon", range: "1-10", stats: { atk: 25, hit: 5, spd: -2 }, ingredients: { "獸人後腿肉": 3, "史萊姆黏液": 2 }, desc: "半獸人骨精煉的重劍，攻擊力大提升。" },
    ...
    { name: "🗡️ 冰晶銳刺", type: "weapon", range: "11-20", stats: { atk: 32, critChance: 8, hit: 10 }, ingredients: { "寒冰霜塵": 2, "怨靈淚晶": 3 }, desc: "像冰錐一樣銳利的突刺短劍。" },
    ...
    { name: "👕 毒霧皮大衣", type: "armor", range: "11-20", stats: { maxHp: 100, block: 3, mdef: 6 }, ingredients: { "毒蜘蛛腺體": 2, "腐屍毒素": 2 }, desc: "散發出刺鼻蛛毒氣味的厚皮大衣。" },
    { name: "🛡️ 霜殼巨盾", type: "armor", range: "11-20", stats: { block: 8, mdef: 5, maxHp: 50 }, ingredients: { "硬殼龜甲": 2, "寒冰霜塵": 2 }, desc: "凍結水汽覆蓋的巨型龜甲防盾。" },
    ...
    { name: "💍 祭司守護指環", type: "accessory", range: "11-20", stats: { block: 4, mdef: 6, mpRegen: 3 }, ingredients: { "祭司血清": 1, "巨石苔蘚": 2 }, desc: "銘刻了墮落神殿防禦禱文的銀環。" },
    { name: "📿 枯骨吊墜", type: "accessory", range: "11-20", stats: { maxHp: 60, mdef: 4 }, ingredients: { "腐屍毒素": 3, "怨靈淚晶": 3 }, desc: "散發死亡氣息的骷髏吊墜。" },
    { name: "💍 鋼殼重戒", type: "accessory", range: "11-20", stats: { block: 5, mdef: 3 }, ingredients: { "硬殼龜甲": 3 }, desc: "用陸龜最硬的那塊殼打磨成的指環。" },

    // ==================== 🔥 LEVEL 21-30 熔岩精煉 ====================
    { name: "🗡️ 烈焰熔劍", type: "weapon", range: "21-30", stats: { atk: 65, hit: 10, spd: -2 }, ingredients: { "烈焰餘燼": 3, "史萊姆黏液": 5 }, desc: "將焦土烈焰灌注鐵劍的熔岩重劍。" },
    { name: "🏹 爆熱強弩", type: "weapon", range: "21-30", stats: { atk: 50, hit: 20, spd: 6 }, ingredients: { "熔岩鱗片": 3, "哥布林香料": 5 }, desc: "弓弦以高熱鱗片拉絲製成的重型手弩。" },
    { name: "🗡️ 地獄赤骨匕首", type: "weapon", range: "21-30", stats: { atk: 45, critChance: 15, flee: 6 }, ingredients: { "焦黑骨碎": 4, "怨靈淚晶": 6 }, desc: "刺激殺意的邪骨尖刃，暴擊率驚人。" },
    ...
    { name: "👕 熔岩重型鎧甲", type: "armor", range: "21-30", stats: { block: 16, mdef: 8, maxHp: 120, spd: -5 }, ingredients: { "熔岩鱗片": 4, "硬殼龜甲": 3 }, desc: "結合龜甲與熔岩高溫板甲，防禦超凡。" },
    ...
    { name: "🛡️ 熔火防爆頭盔", type: "armor", range: "21-30", stats: { block: 6, mdef: 6, maxHp: 100 }, ingredients: { "焦黑骨碎": 3, "毒蜘蛛腺體": 4 }, desc: "覆蓋蛛網隔熱層的火山探索鋼盔。" },
    
    { name: "💍 暴烈灰燼指環", type: "accessory", range: "21-30", stats: { atk: 15, hit: 8, critChance: 5 }, ingredients: { "烈焰餘燼": 4, "史萊姆黏液": 8 }, desc: "每捏碎一次手指都帶有微量爆發的指環。" },
    { name: "📿 熔岩不滅護身符", type: "accessory", range: "21-30", stats: { maxHp: 80, flee: 8 }, ingredients: { "熔岩鱗片": 3, "寒冰霜塵": 5 }, desc: "冰火相融，賦予強大的身法與生命提升。" },
    { name: "💍 禁忌魔導書指環", type: "accessory", range: "21-30", stats: { matk: 12, mpRegen: 12 }, ingredients: { "魔導碎頁": 4, "巨石苔蘚": 6 }, desc: "鑲崁了殘缺魔法書頁的智慧魔戒。" },
    { name: "📿 赤骨項鍊", type: "accessory", range: "21-30", stats: { hit: 12, critChance: 6 }, ingredients: { "焦黑骨碎": 3, "怨靈淚晶": 6 }, desc: "用被灼燒骷髏齒骨穿成的戰鬥頸鍊。" },
    { name: "💍 食人魔蠻力戒", type: "accessory", range: "21-30", stats: { block: 8, maxHp: 50 }, ingredients: { "食人魔厚皮": 4, "獸人後腿肉": 6 }, desc: "大大激發肌肉力量的粗獷鐵環。" },

    // ==================== 🌀 LEVEL 31-40 虛空時空 ====================
    { name: "🗡️ 虛空時空裂刃", type: "weapon", range: "31-40", stats: { atk: 95, hit: 18, spd: 8 }, ingredients: { "虛空眼球": 3, "時空皮革": 2, "史萊姆黏液": 10 }, desc: "【頂級神兵】扭曲虛空時空打造的太刀。" },
    { name: "🏹 異次元黑洞巨弓", type: "weapon", range: "31-40", stats: { atk: 75, hit: 30, spd: 12 }, ingredients: { "吸血毒牙": 4, "時空皮革": 3, "哥布林香料": 10 }, desc: "射出的箭矢帶有微弱時空牽引力的長弓。" },
    { name: "🗡️ 符文刻印大劍", type: "weapon", range: "31-40", stats: { atk: 110, hit: 10, spd: -4 }, ingredients: { "符文石板": 4, "巨石苔蘚": 10 }, desc: "巨重石板雕琢而成，刻滿了爆烈符文。" },
    { name: "🪓 九頭蛇狂暴血斧", type: "weapon", range: "31-40", stats: { atk: 85, hit: 12, critChance: 10 }, ingredients: { "九頭蛇血": 3, "獸人後腿肉": 10 }, desc: "用九頭蛇蛇毒與活性血淬鍊的嗜血狂斧。" },
    { name: "🪄 虛空眼球凝視法杖", type: "weapon", range: "31-40", stats: { matk: 90, mpRegen: 16, mdef: 12 }, ingredients: { "虛空眼球": 4, "魔導碎頁": 5 }, desc: "頂端鑲嵌活體眼球的詭異法杖，增幅魔力。" },
    
    { name: "🛡️ 帝王蟹巨型重盾", type: "armor", range: "31-40", stats: { block: 25, mdef: 15, maxHp: 250, spd: -6 }, ingredients: { "帝王蟹腿": 2, "硬殼龜甲": 6 }, desc: "海中巨鎧霸主巨螯改造，減傷高達 25 點！" },
    { name: "👕 時空閃爍皮甲", type: "armor", range: "31-40", stats: { maxHp: 180, flee: 18 }, ingredients: { "時空皮革": 4, "怨念皮翼": 8 }, desc: "時空皮革縫製，身體呈現半躍遷閃爍狀態。" },
    { name: "🛡️ 符文壁障面罩", type: "armor", range: "31-40", stats: { block: 15, mdef: 10, maxHp: 150 }, ingredients: { "符文石板": 3, "焦黑骨碎": 6 }, desc: "散發出淡淡能量迴路幽光的防禦面罩。" },
    { name: "👕 九頭蛇皮鱗甲", type: "armor", range: "31-40", stats: { maxHp: 300, block: 10, mdef: 10 }, ingredients: { "九頭蛇血": 2, "熔岩鱗片": 5 }, desc: "帶有超強自愈活性細胞的多層皮甲。" },
    ...
    { name: "💍 吸血鬼尖牙牙環", type: "accessory", range: "31-40", stats: { atk: 12, hit: 10 }, ingredients: { "吸血毒牙": 4, "腐屍毒素": 10 }, desc: "將妖蝠毒牙內彎製成的鋒利戒指。" },
    { name: "📿 碑文殘片掛飾", type: "accessory", range: "31-40", stats: { block: 12, mdef: 10, maxHp: 100 }, ingredients: { "符文石板": 4, "巨石苔蘚": 8 }, desc: "上古遺蹟斷碑殘片串成的重型護身符。" },
    { name: "💍 活性蛇血指環", type: "accessory", range: "31-40", stats: { maxHp: 150, mpRegen: 5 }, ingredients: { "九頭蛇血": 3, "史萊姆黏液": 12 }, desc: "戴上後能感受到心跳同步狂飆的活性血戒。" },

    // ==================== 👿 LEVEL 41-50 惡魔煉獄 ====================
    { name: "🗡️ 惡魔狂怒大劍", type: "weapon", range: "41-50", stats: { atk: 150, hit: 15, spd: -5 }, ingredients: { "惡魔之角": 3, "獸人後腿肉": 15 }, desc: "熔鑄了深淵惡魔長角，暴力美學的終極代表。" },
    { name: "🗡️ 墜落暗刃太刀", type: "weapon", range: "41-50", stats: { atk: 120, hit: 25, spd: 14 }, ingredients: { "暗刃鋼片": 4, "時空皮革": 6 }, desc: "漆黑吸光的暗殺寶刀，出刀無聲，速度絕倫。" },
    { name: "🪓 奪心者靈魂撕裂斧", type: "weapon", range: "41-50", stats: { atk: 135, critChance: 20 }, ingredients: { "奪心碎晶": 3, "焦黑骨碎": 10 }, desc: "揮舞時能產生精神噪音，直接擊碎靈魂防線。" },
    { name: "🗡️ 烈地黑龍爪刃", type: "weapon", range: "41-50", stats: { atk: 140, hit: 20, critChance: 12 }, ingredients: { "地龍魔爪": 3, "熔岩鱗片": 8 }, desc: "地底惡龍利爪尖端拼裝而成的爪刃，撕裂傷拉滿。" },
    { name: "🪄 泣血妖花劇毒魔杖", type: "weapon", range: "41-50", stats: { matk: 130, mpRegen: 22, mdef: 18 }, ingredients: { "泣血花瓣": 4, "魔導碎頁": 12 }, desc: "妖豔魔花攀附的劇毒短杖，奧術迴路空前暢通。" },
    
    { name: "👕 狂魔胸甲", type: "armor", range: "41-50", stats: { block: 35, mdef: 20, maxHp: 400, spd: -6 }, ingredients: { "惡魔之角": 3, "硬殼龜甲": 12 }, desc: "融合惡魔之角和龜殼淬鍊的惡魔護身鎧。" },
    { name: "👕 暗影夜行緊身衣", type: "armor", range: "41-50", stats: { maxHp: 280, flee: 25 }, ingredients: { "暗刃鋼片": 3, "時空皮革": 8 }, desc: "穿戴後整個人融入地貌陰影，閃避率狂飆。" },
    { name: "🛡️ 精神壁障重盾", type: "armor", range: "41-50", stats: { block: 28, mdef: 25, maxHp: 300 }, ingredients: { "奪心碎晶": 3, "符文石板": 8 }, desc: "散發出暗紫色精神能量磁場的念動巨盾。" },
    { name: "👕 龍鱗隔熱防護衣", type: "armor", range: "41-50", stats: { maxHp: 500, block: 20, mdef: 15 }, ingredients: { "地龍魔爪": 2, "食人魔厚皮": 10 }, desc: "地龍護體鱗片精心織造，隔熱性能與強度極佳。" },
    ...
    { name: "💍 奪心碎晶幻覺指環", type: "accessory", range: "41-50", stats: { flee: 22 }, ingredients: { "奪心碎晶": 4, "毒蜘蛛腺體": 12 }, desc: "能使周圍怪物的視覺與感知產生偏移的迷幻魔戒。" },
    { name: "📿 巨龍魔骨護身符", type: "accessory", range: "41-50", stats: { maxHp: 250, block: 15, mdef: 15 }, ingredients: { "地龍魔爪": 3, "巨石苔蘚": 15 }, desc: "穿透了地龍背骨，常駐散發龍威的守護護符。" },
    { name: "💍 泣血花吻戒指", type: "accessory", range: "41-50", stats: { matk: 25, critChance: 10 }, ingredients: { "泣血花瓣": 4, "史萊姆黏液": 16 }, desc: "【魔攻神戒】每一次魔力釋放都宛如妖花之吻。" },
    ...
    { name: "🗡️ 重力塌陷碎星錘", type: "weapon", range: "51-60", stats: { atk: 280, block: 20, mdef: 20 }, ingredients: { "重力奇點": 4, "符文石板": 10, "巨石苔蘚": 20 }, desc: "揮舞時能產生重力偏折，大幅度增加自身防禦面板與重量感。" },
    ...
    { name: "👕 宇宙混沌不滅戰鎧", type: "armor", range: "51-60", stats: { block: 60, mdef: 45, maxHp: 800, spd: -8 }, ingredients: { "混沌核心": 4, "地龍魔爪": 10, "硬殼龜甲": 20 }, desc: "終極防線！集惡龍爪與陸龜甲、混沌材料，防禦驚天動地。" },
    { name: "👕 織星斗篷", type: "armor", range: "51-60", stats: { maxHp: 500, flee: 35 }, ingredients: { "星塵碎片": 4, "時空皮革": 12, "怨念皮翼": 15 }, desc: "用流星落下的織網製成的斗篷，閃避與生命並存。" },
    { name: "🛡️ 重力奇點扭曲神盾", type: "armor", range: "51-60", stats: { block: 45, mdef: 35, maxHp: 600 }, ingredients: { "重力奇點": 4, "硬殼龜甲": 15, "焦黑骨碎": 15 }, desc: "中心鑲嵌重力奇異點，能讓襲來的物理打擊軌跡發生偏折。" },
    { name: "👕 死神寂滅風衣", type: "armor", range: "51-60", stats: { maxHp: 450, spd: 40, flee: 20 }, ingredients: { "死神鐮刃": 3, "暗刃鋼片": 10, "時空皮革": 10 }, desc: "死神黑霧繚繞的殘破風衣，穿戴後速度突破常理上限。" },
    { name: "🛡️ 秩序判決皇冠", type: "armor", range: "51-60", stats: { block: 30, mdef: 40, maxHp: 550 }, ingredients: { "裁決羽毛": 4, "奪心碎晶": 10, "符文石板": 12 }, desc: "神聖羽毛與銘刻石板鑲鑄而成的判決頭盔，全防提升。" },
    
    { name: "💍 星塵風暴流光戒", type: "accessory", range: "51-60", stats: { critChance: 25, hit: 20 }, ingredients: { "星塵碎片": 5, "吸血毒牙": 12, "烈焰餘燼": 20 }, desc: "極光盤旋的指環，使暴擊率與精準度發生史詩級爆發。" },
    ...
    { name: "💍 奇點時空重力環", type: "accessory", range: "51-60", stats: { block: 20, spd: 15, flee: 15 }, ingredients: { "重力奇點": 4, "毒蜘蛛腺體": 15, "寒冰霜塵": 20 }, desc: "極大改寫身體重力密度的臂環，同時增加爆發速度與減傷。" },
...
const MARKET_ITEMS_POOL = [
    ...
    { name: "🛡️ 鋼鐵臨時防禦膠囊", price: 25, desc: "本場戰鬥物理防禦暫時增加 15 點。" },
    { name: "⚡ 狂暴腎上腺素針", price: 40, desc: "本場戰鬥暴擊機率（Crit）暫時暴增 25%。" },
    { name: "🐾 貓神輕盈肉墊粉", price: 35, desc: "本場戰鬥閃避率暫時增加 15%。" },
    ...
    { name: "🪓 鋼鐵碎甲鐵飛刀", price: 35, desc: "擲出飛刀，永久削弱當前魔物 8 點基礎防禦。" },
    ...
    { name: "🛡️ 木屑膠合臨時防面罩", price: 15, desc: "粗糙的護具，增加 1 點減傷。" },
